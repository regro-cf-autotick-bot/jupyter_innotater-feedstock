...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jupyter_innotater-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13471&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyter_innotater-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jupyter_innotater` can be installed with:

```
conda install jupyter_innotater
```

It is possible to list all of the versions of `jupyter_innotater` available on your platform with:
